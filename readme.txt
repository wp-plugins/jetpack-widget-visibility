...
Jetpack Widget Visibility adds a new button to every widget in the widget area, allowing you to choose on which page this particular widget appears.
...
This plugin is the exact Widget Visibility module of the original Jetpack plugin, only without all the extra stuff.
